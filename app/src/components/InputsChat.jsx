    ...
    <>
      <InputsWrapper>
        <div style={{ width: '100%' }}>
          ...
          <Box sx={{ display: 'flex', gap: '0.75rem', marginTop: '0.75rem', flexDirection: { xs: 'column', sm: 'row' } }}>
            ...
            <Box sx={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end', flexDirection: 'row' }}>
      ...
      {!isConnected && <p style={{ fontSize: '.75rem',color: 'var(--muted)', marginTop: '.5rem'}}>Conecte-se a uma sala para começar a conversar.</p>}
    </>
  );
}